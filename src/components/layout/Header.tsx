      ...
      <div className="flex items-center gap-4 flex-1 max-w-xl">
        ...
        <div className="relative flex-1 group">
          ...
          <input 
            ...
            className="w-full bg-slate-100 border-transparent focus:bg-white focus:border-slate-200 focus:ring-1 focus:ring-blue-100 rounded-lg py-2 pl-10 pr-4 text-sm transition-all"
          />
        </div>
      </div>
