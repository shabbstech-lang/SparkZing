...
export function AdminLogin() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    if (!success) {
      setError('Invalid username and password. Note: Database access requires Google Sign-In.');
      setCountdown(8);
    }
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 font-medium mt-2">Secure database access required</p>
        </div>
        ...
        <div className="space-y-6">
          <button 
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-100 py-4 rounded-2xl font-black uppercase text-[11px] tracking-[0.1em] shadow-sm hover:bg-slate-50 active:scale-[0.98] transition-all disabled:opacity-50"
          >
          ...
          <div className="relative">
             ...
             <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-4 text-slate-400 font-bold tracking-widest">or mock access</span></div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  disabled={isLoggingIn || countdown !== null}
            ...
            >
              {isLoggingIn ? 'Checking...' : 'Authenticate Now'}
            </button>
          </form>
        </div>
